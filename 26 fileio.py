...
# 간단한 인삿말을 파일에 저장
# open(파일경로, 작업모드) * py2 버전
f = open('hello.data', 'w')
f.write('Hello, World!!')
f.close()

# with open(파일경로, 작업모드, 인코딩) as 별칭 * py3 버전 (한글을 쓸 때는 인코딩해야함)
